...
with tab1:
    ...
    df = pd.read_csv(r'C:\Users\adics\Downloads\CO2 emissions from fuel combustion, Indonesia.csv')
    ...
    # data kedua
    df2 = pd.read_csv(r'C:\Users\adics\Downloads\CO2 emissions by sector, Indonesia, 2021.csv')
...
with tab2:
    ...
    # data ketiga
    pembangkit = pd.read_csv(r"C:\Users\adics\Downloads\Electricity generation sources, Indonesia, 2021.csv")
    emisibbm= pd.read_csv(r"C:\Users\adics\Downloads\Emissions from power generation by source, Indonesia, 2021.csv")
    ...
    # hubungan regresi
    sumber_listrik = pd.read_csv(r'C:\Users\adics\Downloads\electricity generation sources in Indonesia.csv')
    karbon_listrik = pd.read_csv(r'C:\Users\adics\Downloads\emissions from power generation by source in Indonesia.csv')
